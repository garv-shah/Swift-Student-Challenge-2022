...
struct Simulation: View {
    ...
    @State private var isAR: Bool = false
    ...
    var body: some View {
        if isAR {
            VStack {
                ...
                // AR Button
                .floatingActionButton(color: .accentColor, image: Image(systemName: "cube.transparent").foregroundColor(.white), align: ButtonAlign.right, customY: 320, customX: sideButtonsX, opacity: sideButtonsOpacity) {
                    // gimmo

                    //arDelegate.arView?.scene = solarscene.scene

                    withAnimation() {
                        playing = false
                        isAR.toggle()

                        solarscene = SolarScene(focusOnBody: solarscene.focusOnBody,
                                                focusIndex: solarscene.focusIndex,
                                                trails: solarscene.trails,
                                                velocityArrows: solarscene.velocityArrows,
            ...
            VStack {
                ...
                .floatingActionButton(color: .accentColor, image: Image(systemName: "cube.transparent").foregroundColor(.white), align: ButtonAlign.right, customY: 320, customX: sideButtonsX, opacity: sideButtonsOpacity) {
                    ...
                    withAnimation() {
                        ...
                        solarscene = SolarScene(focusOnBody: false,
                                                focusIndex: 0,
                                                trails: solarscene.trails,
                                                velocityArrows: solarscene.velocityArrows,
                                                gravitationalConstant: 1,
                                                inputBodies: [
                                                    BodyDefiner(name: "Sun", mass: 20.0, velocity: SCNVector3(0, 0, 0), position: SCNVector3(0, -40, 0), color: UIColor.systemYellow),
                                                    BodyDefiner(name: "Earth", mass: 6.0, velocity: SCNVector3(0, 0, 0.65), position: SCNVector3(70, -40, 0), color: UIColor.systemGreen),
                                                    BodyDefiner(name: "Moon", mass: 1, velocity: SCNVector3(0, 0.025, 0), position: SCNVector3(85, -40, 0), color: UIColor.systemBlue),
                                                    BodyDefiner(name: "Mars", mass: 5.0, velocity: SCNVector3(0, 0, -0.4), position: SCNVector3(150, 40, 0), color: UIColor.systemRed),
                                                ],
                                                allowCameraControl: true)
                        arDelegate.arView?.scene = solarscene.scene
                    }
